        ...
        <div class="row">
            <div class="col-md-3" style="border-style: solid;">
                ...
                for($j = 0; $j < 7; $j++){
                    ...
                    //var_dump($daysTasks);
                    echo "<div>";
                    echo "<label class='dayTitle'>$dayOfTheWeek[$i]&nbsp;&nbsp;" . date("D, M d", strtotime($scheduleDate)) . "</label>";
                    if(sizeof($daysTasks) > 0){
                        foreach($daysTasks as $tasks) {
                            echo "<ul><li class='taskTitle'>" . ucfirst($tasks["task_title"]) . "</li></ul>";
                        }
                    } else {
            ...
            <div class="col-lg-6 todayEvents" style="border-style: solid;">
                ...
                if(sizeof($events) > 0){
                    ...
                    foreach($events as $event){
                        ...
                        echo "<ul> <li class='taskDescription''> " . $event["task_description"] . "</li></ul>";
                    }
                } else {
